...
#define SHELL_CMD_VML_HELP  "List all VMs info"

#define SHELL_CMD_VMC	    "vmc"
#define SHELL_CMD_VMC_PARAM "<vm id>"
#define SHELL_CMD_VMC_HELP \
	"Switch to the VM's console. Use [@c] to return to the aVisor console"

#define SHELL_CMD_VMLD	     "vmld"
#define SHELL_CMD_VMLD_PARAM "<image file name> <load addr> <entry addr> <pcpu id>"
#define SHELL_CMD_VMLD_HELP  "Load the VM image and run it on <pcpu id>"
...
#define SHELL_CMD_TEST_PARAM NULL
#define SHELL_CMD_TEST_HELP  "For test"
